...
This is a Node.js application that fulfills the Fetch Backend Apprenticeship Take Home Assessment where I build out a webservice that fulfills a receipt processor API.
More details on the Receipt Processor API is below the Docker instructions.

## Prerequisites

Before you begin, ensure you have Docker installed on your machine. If not, you can download and install it from [Docker's official website](https://www.docker.com/get-started).

## Getting Started (Docker Instructions)
...
Ensuring you're in the project repository enter this line in your terminal:
